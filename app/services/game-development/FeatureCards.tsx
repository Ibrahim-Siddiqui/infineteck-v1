...
import { Codepen, Network, Waypoints } from "lucide-react";

const FeatureCards = () => {
  const WebCardsData = [
    {
      id: 1,
      name: "Engaging 2D Games",
      desc: "Craft visually appealing 2D games with smooth animations and interactive gameplay.",
      icon: <Waypoints size={48} />,
    },
    {
      id: 2,
      name: "Immersive 3D Worlds",
      desc: "Develop high-quality 3D environments with realistic physics and dynamic mechanics.",
      icon: <Codepen size={48} />,
    },
    {
      id: 3,
      name: "Cross-Platform Compatibility",
      desc: "Build games for PC, mobile, and consoles with seamless multiplayer integration.",
