...
const HeroCounter = () => {
  return (
    <div className="text-primary-color">
        <div className="grid grid-cols-3 lg:flex lg:justify-start pr-[10%] lg:px-[5%]">
          ...
          <div className="w-full md:w-1/2 lg:w-1/4 py-8">
            <div className="">
                <CountUp end={98} duration={2} className='text-4xl md:text-5xl  font-semibold text-center'/>
              <h2 className="inline text-4xl md:text-5xl  font-semibold text-center">
                %
              </h2>
